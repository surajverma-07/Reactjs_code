...
function Card({image,Heading="website" , weblink="#",text="ye h hamari website "}){
    ...
    return(
        ...
        <div className="py-3 text-center w-full ">
          ...
          <button
            type="button"
            className="mt-4 rounded-md bg-[#ec5b53] dark:bg-[#DA0037] px-6 py-1  text-xl font-semibold group-hover:bg-[#0C2D57] dark:group-hover:bg-[#444444] dark:group-hover:text-[#DA0037] text-[#EFECEC]  shadow-sm focus-visible:outline  focus-visible:outline-2 focus-visible:outline-offset-2 "
