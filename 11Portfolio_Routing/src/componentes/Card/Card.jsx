...
function Card({image,Heading="website" , weblink="#",text="ye h hamari website "}){
    ...
    return(
        <div className="w-[400px]  rounded-lg border shadow-md  hover:bg-[#FC6736] hover:scale-105  group  ">
        <img
          src={image}
          alt="Laptop"
        ...
        <div className="py-3 text-center ">
          ...
          <p className="mt-3 text-lg text-gray-800 px-4 group-hover:text-[#EFECEC]">
                 {text}
          </p>
          <button
            type="button"
