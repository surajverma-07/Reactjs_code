...
export default function About() {
    return (
        <section id="about" name="about" className='py-14 flex flex-col gap-y-24 bg-[#EFECEC]'>

        <div className="about-left border py-5 w-[60vw] mx-auto rounded-lg  text-center shadow-lg  ">
        ...
        <div className="about-right flex text-center justify-evenly w-[60vw] shadow-lg mx-auto border rounded-lg py-10 ">
